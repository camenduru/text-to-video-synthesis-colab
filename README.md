...
| Colab | Type
| --- | --- |
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/camenduru/text-to-video-synthesis-colab/blob/main/zeroscope_video_webui_colab.ipynb) | zeroscope_video_webui_colab [cerspense/zeroscope_v2_576w](https://huggingface.co/cerspense/zeroscope_v2_576w) [cerspense/zeroscope_v2_XL](https://huggingface.co/cerspense/zeroscope_v2_XL) <br /> for upscale edit /content/ui/models/ModelScope/t2v/configuration.json <br /> open_clip_pytorch_model.bin to open_clip_pytorch_model_up.bin <br /> open_clip_pytorch_model.bin to text2video_pytorch_model_up.pth
